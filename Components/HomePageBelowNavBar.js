  ...
  return `<div id="belowNavBarDiv1">
    ...
    <div>
      ...
      <div id="HomeSearchContainer">
        <div id="HomeSearchCity">
          <div id="HomeSearchCityDiv">
            <input
              id="HomeSearchCityInput"
              type="text"
              placeholder="Cities..."
            />
            <div><i id="icon1" class="fas fa-angle-down"></i></div>
          </div>
          <div id="HomeSearchCity2"></div>
        </div>
        <div id="HomeSearchType">
          <div id="HomeSearchTypeDiv">
            <input
              id="HomeSearchTypeInput"
              type="text"
              placeholder="Type..."
            />
            <div><i id="icon2" class="fas fa-angle-down"></i></div>
          </div>
          <div id="HomeSearchType2"></div>
        </div>
        <div id="HomeSearchPreferences">
          <div id="HomeSearchPreferencesDiv">
            <input
              id="HomeSearchPreferencesInput"
              type="text"
              placeholder="Preferences..."
            />
            <div><i id="icon3" class="fas fa-angle-down"></i></div>
          </div>
          <div id="HomeSearchPreferences2"></div>
        </div>
        <div>OR</div>
